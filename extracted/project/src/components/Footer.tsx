    ...
    <footer className="bg-gray-800 text-white pt-12 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Plateforme de billetterie en ligne pour tous vos événements avec validation par code QR.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/events" className="text-gray-400 hover:text-white transition">Événements</Link></li>
              <li><Link to="/login" className="text-gray-400 hover:text-white transition">Connexion</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center space-x-2">
                ...
                <span className="text-gray-400">+212 706-563723</span>
              </li>
              <li className="flex items-center space-x-2">
                <Mail className="h-5 w-5 text-gray-400" />
                <span className="text-gray-400">contact@QRticketPro.ma</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} QRticketPro. Tous droits réservés.</p>
        </div>
      </div>
    </footer>
  );
